...
#from s3conv2dshift import S3Conv2dShift3bit as Conv2dShift
#from s3conv2dshift import add_reg_sparse_to_loss
from s8conv2dshift import S8Conv2dShift8bit as Conv2dShift
from s8conv2dshift import add_reg_sparse_to_loss
...
def conv3x3_s3(in_planes, out_planes, stride=1):
    "3x3 convolution with padding"
    return Conv2dShift(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=1, bias=False)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                Conv2dShift(self.inplanes, planes * block.expansion,
    ...
    def init_model(self):
        ...
        for m in self.modules():
            ...
            if isinstance(m, Conv2dShift):
                ...
                #for i in range(len(m.weight_shifts)):
                #    m.weight_shifts[i].data.normal_(0, math.sqrt(2. / n))
...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10,
        ...
        self.fcx = nn.Linear(64, num_classes)
