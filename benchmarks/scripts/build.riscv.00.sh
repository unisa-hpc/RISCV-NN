...
function set_compiler_flags() {
    ...
    if [[ "$is_gcc_flag" -eq 1 ]]; then
        ...
        flags_vec="-c -O3 -march=rv64gcv_zvl256b -ffast-math -fno-vectorize -Wall -Wextra -v -I$script_dir/../../common $extra_flags"
        flags_scalar_vec="-c -O3 -march=rv64gcv_zvl256b -ffast-math -DAUTOVEC -fvectorize -Rpass=loop-vectorize -Wall -Wextra -v -I$script_dir/../../common $extra_flags"
        flags_scalar_novec="-c -O3 -march=rv64gcv_zvl256b -ffast-math -fno-vectorize -Wall -Wextra -v -I$script_dir/../../common $extra_flags"
    else
