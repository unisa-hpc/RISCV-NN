def get_tunable_params_list(bench_id: int):
    ...
    if bench_id == 0:
        print(f'The given bench_id of {bench_id} is does not need any tunable parameters (get_tunable_params).')
        return None
        ...
        print(f'The given bench_id of {bench_id} is defined yet (get_tunable_params).')
        return None
